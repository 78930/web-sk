...
// Strip internal schema field prefix (e.g. "phone: ...") from server errors
        ...
        <>
                                  ...
                                  {/* Form */}
                                            <div className="card p-8">
                                                          <div className="text-center lg:text-left">
                                                                          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Create your account</h2>h2>
                                                                          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">It's free — no card required.</p>p>
                                                          </div>div>
                                            
                                                          <div className="mt-6">
                                                                          <span className="label-field">I want to join as a…</span>span>
          ...
          { id: "factory", label: "Factory", icon: Icon.Briefcase, desc: "Looking to hire" },
                                                  ...
                                                  <button
                                                                        ...
                                                                        <div className="mt-2 font-semibold text-slate-900 dark:text-white">{opt.label}</div>div>
                                                                        <div className="text-xs text-slate-500 dark:text-slate-400">{opt.desc}</div>div>
                                                  </button>button>
                                                ))}
                                                                          </div>div>
                                                          </div>div>
